...
;(function () {
  ...
  // api接口请求地址
  window.SITE_CONFIG['baseUrl'] = 'http://active.aomygod.com/amg-activity-report-admin';

  // 嵌套iframe地址
  window.SITE_CONFIG['nestIframeUrl'] = 'http://active.aomygod.com/amg-activity-report-admin';
  // 嵌套iframe路由名称列表
